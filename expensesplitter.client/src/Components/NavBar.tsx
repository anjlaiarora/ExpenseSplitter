...
<nav className="bg-white  w-full z-20 sticky top-0  shadow-md  start-0">
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
  <a href="/" className="flex items-center space-x-3 rtl:space-x-reverse">
      <span className="self-center text-3xl font-bold whitespace-nowrap text-black">SPLITIFY</span>
  </a>
