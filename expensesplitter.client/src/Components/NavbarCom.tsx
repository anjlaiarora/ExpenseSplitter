...
const NavbarCom = () => {
  ...
  return (
    <div>
      ...
      <Nav>
        <Navbar collapseOnSelect expand="lg" classNameName="bg-body-dark navbar-expand-xxl w-100">

          <Navbar.Brand classNameName='text-primary ps-5 mt-2'><h2>Splitify<img src='https://cdn-icons-png.freepik.com/512/8436/8436281.png' width={40} classNameName="ps-1" /></h2></Navbar.Brand>
