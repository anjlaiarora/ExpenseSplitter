...
const Dashboard = () => {
  ...
  return (
    ...
    <div style={{display:'flex', justifyContent:'space-between',paddingTop:'100px',gap:'30px',paddingLeft:'40px',width:'1350px'}}>
      ...
      <div>
        <img src="https://media.istockphoto.com/id/1291977082/vector/a-young-woman-multitasking-abstract-concept-of-active-work-deadline-information-search-on.jpg?s=612x612&w=0&k=20&c=Hb_4Ywd1d3diVk4CH3D1REnzg388TR6DeRFidMGsYKo=" alt=""  />
      </div>
    </div>
    </>
